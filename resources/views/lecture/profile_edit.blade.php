                            ...
                            <ul class="navbar-nav align-items-center ml-auto ml-md-0">
                                <li class="nav-item dropdown">
                                    ...
                                    <div class="dropdown-menu dropdown-menu-right">
                                        ...
                                        <a href="{{ route('lecture_profile') }}" class="dropdown-item">
                    ...
                    <div class="card card-profile">
                        ...
                        <div class="card-body pt-0">
                            ...
                            <div class="text-center">
                                <h5 class="h3">
                                    {{ $data['name'] }} <span class="font-weight-light">, 27</span>
                                </h5>
                                <div class="h5 font-weight-300">
                                    <i class="ni location_pin mr-2"></i>Pemalang, Indonesia
                                </div>
                                <div class="h5 mt-4">
                                    <i class="ni business_briefcase-24 mr-2"></i>Information System | {{ $data['expertises'] }}
                                </div>
                                <div>
                            ...
                            <form method="POST" enctype="multipart/form-data">
                                ...
                                <div class="pl-lg-4">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label class="form-control-label" for="number">NIP / NIDN</label>
                                                <input type="number" id="nidn" class="form-control"
                                                    name="nidn" placeholder="NIP / NIDN" value="{{ $data['nidn'] }}">
                                            </div>
                                        </div>
                                        <div class="col-lg-6">
                                            <div class="form-group">
                                                <label class="form-control-label">Expertises</label>
                                                <input type="text"class="form-control" name="expertises" placeholder="Write down your expertises (ex: Back-End Engineering)" name="expertises" value="{{ $data['expertises'] }}"></input>
                                            </div>
                                        </div>
                                    </div>
                                </div>
