                    ...
                    <div class="px-4">
                        <div class="row justify-content-left">
                            ...
                            <div class="col order-lg-3 text-lg-left alight-self-lg-left mt-3">
                                <div class="card-profile-text">
                                    ...
                                    <div class="h6 font-weight-300">Information System | {{ $data['expertises'] }}</div>
                                </div>
                            </div>
                        ...
                        <div class="mt-5 py-5 border-top text-center">
                            <div class="row justify-content-center">
                                <div class="col-lg-9">
                                    <p> Lorem ipsum dolor sit amet consectetur adipisicing elit. Provident quas ab laboriosam eaque assumenda repudiandae doloremque, reiciendis ea! Eveniet molestias quo, natus optio odio molestiae ut assumenda harum. Impedit, est. </p>
                                </div>
                            </div>
                        </div>
