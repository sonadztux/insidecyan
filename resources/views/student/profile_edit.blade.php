                            ...
                            <form method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group">
                                                ...
                                                <input id="address" class="form-control" placeholder="Your domicile address" value="{{ $data['address'] }}" type="text" name="address">
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                ...
                                                <input type="number" id="phone" class="form-control" placeholder="Phone Number" value="{{ $data['phone'] }}" name="phone">
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                <label class="form-control-label" for="instgram"> Instagram Profile</label>
                                                <input type="text" id="instgram" class="form-control"
                                                    placeholder="url" value="www.instagram.com/sonadztux" name="instagram">
                                            </div>
                                        </div>
                                        <div class="col-lg-4">
                                            <div class="form-group">
                                                <label class="form-control-label" for="linkedin">Linkedin Profile</label>
                                                <input type="text" id="linkedin" class="form-control" placeholder="url" value="https://www.linkedin.com/in/nanda-arfan-hakim/" name="linkedin">
                                            </div>
                                        </div>
                                ...
                                <div class="pl-lg-4">
                                    <div class="form-group">
                                        ...
                                        <textarea rows="4" class="form-control" placeholder="Write down some interesting about you" name="biography">{{ $data['biography'] }}</textarea>
                                    </div>
                                </div>
                                <div class="pl-lg-4">
                                    <div class="form-group">
                                        <label class="form-control-label">Specialization</label>
                                        <input type="text"class="form-control" name="specialization" placeholder="Write down your specialization (ex: Back-End Engineering)" name="specialization" value="{{ $data['specialization'] }}"></input>
                                    </div>
                                </div>
                                <hr class="my-4" />
                                {{-- Education --}}
