...
@section('body_content')
    <div class="wrapper">
        <section class="section-profile-cover section-shaped my-0">
            <!-- Circles background -->
            <img class="bg-image" src="{{ asset('light/img/pages/mohamed.jpg') }}" style="width: 100%;">
            <!-- SVG separator -->
                        ...
                        <div class="row justify-content-left">
                            <div class="col-lg-3 order-lg-2">
                                <div class="card-profile-image">
                                    <a href="javascript:;">
                                        <img src="{{ asset('light/img/faces/team-4.jpg') }}" class="rounded-circle">
                                    </a>
                                </div>
                            </div>
                            <div class="col-lg-6 order-lg-3 text-lg-left alight-self-lg-left mt-3">
                                <div class="card-profile-text">
                                    <h3>Nanda Arfan Hakim<span class="font-weight-light">, 21</span></h3>
                                    <div class="h6 font-weight-300">Pemalang, Indonesia</div>
                                    <div class="h6 font-weight-300">Information System | Back End Developer</div>
                                </div>
                            </div>
                            <div class="order-lg-3 text-lg-right align-self-lg-left mt-2">
                                <div class="card-profile-actions py-10 mt-lg-0">
                                    <a href="#" class="btn btn-sm btn-info mr-4">Connect</a>
                                    <a href="/profile/edit" class="btn btn-sm btn-default float-right" >Edit Profile</a>
                                </div>
                            </div>
                                            ...
                                            <div class="card">
                                                ...
                                                <div id="collapseOne" class="collapse show" aria-labelledby="headingOne"
                                                    ...
                                                    <div class="card-body opacity-8">
                                                        ...
                                                        <hr class="solid ml-4 mr-4">
                                                        </hr>
                                                        <div class="media">
                                                            <div class="media-left">
                                                                <a href="#">
                                                                    <img class="media-object"
                                                                        src="https://pbs.twimg.com/profile_images/456687108158001153/knHA5N6e_400x400.png"
                                                                        style="width: 100; height:100px" alt="...">
                                                                </a>
                                                            </div>
                                                            <div class="media-body">
                                                                <h5 class="media-heading"><strong>SMKN 1 Pemalang</strong>
                                                                </h5>
